...
namespace DataConsulting.PuntoVentaComercial.Infrastructure.Configurations
{
    internal sealed class SaleConfiguration : IEntityTypeConfiguration<Sale>
    {
        public void Configure(EntityTypeBuilder<Sale> builder)
        {
            ...
            builder.Property(x => x.Correlativo)
            ...
            builder.Property(x => x.FlagDetraccion).HasColumnName("FlagDetraccion").IsRequired();
            builder.Property(x => x.IdSubdiario).HasColumnName("IdSubdiario");
